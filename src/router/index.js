...
export const asyncRouterMap = [

    {
        ...
        hidden: false,
        children: [
            // {path: '/lecture', name: 'lecture', icon: 'speedometer', component: _import('lecture')},

            // {path: '/dashboard', name: 'Dashboard', icon: 'speedometer', component: _import('Dashboard')},
            {path: '/medical',name: '病例管理',icon:'thumbsup',component: _import('medicalCase/medicalManage')},
            {
                path: '/addCase',
                name: '新增病例',
                icon: 'arrow-graph-up-right',
                component: _import('medicalCase/addCase')
                    },
            // {
            //     path: '/medical', name: '病例管理', redirect: 'medical/medicalManage', icon: 'bookmark',
            //     children: [{
            //         path: 'medicalManage',
            //         name: '病例新增',
            //         icon: 'stats-bars',
            //         component: _import('medicalCase/medicalManage'),
            //     },
            //         {
            //             path: 'addCase',
            //             name: '新增病例',
